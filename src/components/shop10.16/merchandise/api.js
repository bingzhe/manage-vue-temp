 ...
 * 新建得到编号
 */
export const getFoodSn = function (data, callback) {
...
export const getCategory = function (data, callback) {
    Util.DataEncSubmit('category_get.php', data, (resp) => {
        if (callback && typeof callback === "function") {
            callback(resp);
        }
 ...
 * 保存编辑
 */
export const saveEditor = function (data, callback) {
    Util.DataEncSubmit('menu_save.php', data, (resp) => {
        if (callback && typeof callback === "function") {
            callback(resp);
        }
...
export const tagEditor = function (data, callback) {
...
export const saveTagEditor = function (data, callback) {
