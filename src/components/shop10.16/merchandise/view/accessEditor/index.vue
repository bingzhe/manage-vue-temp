            ...
            <div class="content">
                ...
                <div class="food-name clearfix">
                    ...
                    <div class="name-content food-right left">
                        <el-input v-model="foodinfo.food_name" placeholder="请输入配件名"></el-input>
                    </div>
                </div>
                ...
                <div class="food-category clearfix">
                    ...
                    <div class="category-content food-right left">
                        <select-cate @on-change="getSelectId" @on-changeT="getSelectId"></select-cate>
                    </div>
                </div>
                ...
                <div class="food-price clearfix">
                    ...
                    <div class="price-content food-right left">
                        <el-input min="0" type="number" placeholder="请输入价格" v-model="foodinfo.food_price.original_price">
                ...
                <div class="food-stock clearfix">
                    ...
                    <div class="stock-content food-right left">
                        <el-input type="number" v-model="foodinfo.stock_num" placeholder="0表示不限量"></el-input>
                    </div>
                </div>
...
<script>
import { getFoodSn, saveEditor } from "../../api";
...
export default {
  ...
  methods: {
    ...
    getfoodSnn() {
      ...
      getFoodSn(data, this.getfoodSnnHander);
    },
    getfoodSnnHander(resp) {
      if (resp.ret === 0) {
    ...
    getSaveData() {
      let data = {
        ...
        category_id: this.foodinfo.category_id,
        food_price: this.foodinfo.food_price,
        food_num_day: this.foodinfo.stock_num,
