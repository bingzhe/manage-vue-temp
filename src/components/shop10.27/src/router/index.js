...
//			meta: { keepAlive: true }
	...
	},
	{
		...
		children: [{
			...
			path: 'accesseditor',
			component: _import('merchandise/view/accessEditor/index'),
			name: '新增配件编辑'
		}, {
			path: 'drinkeditor',
			component: _import('merchandise/view/drinksEditor/index'),
			name: '新增配酒水编辑'
		},{
			path: 'draft',
			component: _import('merchandise/view/draft/index'),
			name: '菜品草稿列表'
		}]
	},
	{
