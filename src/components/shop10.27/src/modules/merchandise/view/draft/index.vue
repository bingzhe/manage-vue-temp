                    ...
                    <el-table-column min-width="140" align="center" label="操作">
                        <template scope="scope">
                            <span class="blue-text">
                                ...
                                <router-link v-if="scope.row.type === goodType.ACCESSORY" :to="{path:'/good/accesseditor',query: { foodId:scope.row.food_id}}">
                                    编辑
                                </router-link>
                                <router-link v-if="scope.row.type === goodType.DRINK" :to="{path:'/good/accesseditor',query: { foodId:scope.row.food_id}}">
                                    编辑
                                </router-link>
                            </span>
